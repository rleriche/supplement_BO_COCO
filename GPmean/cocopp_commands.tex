...
\providecommand{\algEtables}{\StrLeft{MeanS}{\ntables}}
\providecommand{\algDtables}{\StrLeft{MeanM}{\ntables}}
...
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{rando_M_S_MeanM_MeanS/}
\providecommand{\algorithmA}{M}
\providecommand{\algorithmB}{MeanM}
\providecommand{\algorithmC}{MeanS}
