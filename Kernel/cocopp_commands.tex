...
\providecommand{\algEtables}{\StrLeft{ExpM}{\ntables}}
\providecommand{\algDtables}{\StrLeft{ExpS}{\ntables}}
...
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{rando_M_S_ExpS_ExpM/}
\providecommand{\algorithmA}{ExpM}
\providecommand{\algorithmB}{ExpS}
\providecommand{\algorithmC}{M}
\providecommand{\algorithmD}{S}
\providecommand{\algorithmE}{random}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of objective function evaluations 
             divided by dimension (FEvals/DIM) in 
...
\providecommand{\algFtables}{\StrLeft{ExpL}{\ntables}}
\providecommand{\algEtables}{\StrLeft{ExpM}{\ntables}}
\providecommand{\algDtables}{\StrLeft{ExpS}{\ntables}}
\providecommand{\algCtables}{\StrLeft{S}{\ntables}}
\providecommand{\algBtables}{\StrLeft{M}{\ntables}}
...
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        than 1, with Bonferroni correction by the number of functions (24). A $\downarrow$ indicates the same tested against the reference algorithm. Best results are printed in bold.
        \cocoversion}
\providecommand{\algsfolder}{rando_M_S_ExpS_ExpM_ExpL/}
\providecommand{\algorithmA}{ExpL}
\providecommand{\algorithmB}{ExpM}
\providecommand{\algorithmC}{ExpS}
\providecommand{\algorithmD}{M}
\providecommand{\algorithmE}{S}
\providecommand{\algorithmF}{random}
